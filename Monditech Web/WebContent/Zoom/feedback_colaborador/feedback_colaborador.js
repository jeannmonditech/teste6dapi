...
function BuscaRegistros() {
    ...
    if (!zoom.legado) {
        ...
        feedback.ZoomColaboradoresRegistrosFeedback(search, pagina, qtdPagina, PopulaTabela);

    }
    else {

        feedback.ZoomColaboradoresRegistrosFeedbackLegado(search, pagina, qtdPagina, PopulaTabela);
